...
const { uploadAvatar, getUsers, createAdmin, getAdmins, newsletterSubscription, removeAdminController, deleteUserController, searchUserController } = require("../controllers/users");
